...
const styles = StyleSheet.create({
  ...
  icon: { width: 54, height: 54, borderRadius: 27, color: colors.surface, backgroundColor: colors.danger, fontSize: 32, lineHeight: 54, fontWeight: '700', textAlign: 'center' },
  title: { marginTop: spacing.lg, color: colors.navy, fontSize: 24, fontWeight: '700' },
