    ...
    >
      ...
      <View style={styles.card}>
        ...
        {nativePicker ? (
          <EventDateTimePicker
            key={nativePicker}
            title={nativePicker === 'date' ? 'Event date' : nativePicker === 'start' ? 'Start time' : 'End time'}
            value={pickerValue(
              nativePicker === 'date' ? form.eventDate : nativePicker === 'start' ? form.startTime : form.endTime,
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: colors.muted, fontSize: 13, lineHeight: 19, fontWeight: '500', marginTop: spacing.xs, marginBottom: spacing.lg },
  ...
  accountNoticeTitle: { color: colors.navy, fontSize: 18, fontWeight: '700' },
  ...
  accountButtonText: { color: colors.surface, fontWeight: '700' },
  ...
  field: { gap: 7 },
  label: { color: colors.navy, fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.35 },
  sectionLabel: { color: colors.tealDark, fontSize: 14, fontWeight: '700', paddingTop: spacing.sm, borderTopWidth: 1, borderTopColor: colors.border },
  ...
  posterPlaceholderTitle: { marginTop: spacing.sm, color: colors.tealDark, fontSize: 15, fontWeight: '700' },
  ...
  switchCopy: { flex: 1 },
  switchTitle: { color: colors.navy, fontSize: 14, fontWeight: '700' },
  ...
  eventCategoryLabel: { color: colors.text, fontSize: 12, lineHeight: 15, fontWeight: '700', textAlign: 'center' },
  eventCategoryLabelSelected: { color: colors.tealDark },
  eventSubcategoryHelp: { color: colors.muted, fontSize: 11, fontWeight: '600' },
  ...
  eventSubcategoryText: { color: colors.text, fontSize: 12, lineHeight: 15, fontWeight: '600', textAlign: 'center' },
  ...
  fixedTimeText: { color: colors.surface, fontSize: 13, fontWeight: '700' },
  convertedDate: { color: colors.tealDark, fontSize: 12, fontWeight: '600' },
  ...
  offsetButtonText: { color: colors.tealDark, fontSize: 22, fontWeight: '700' },
  offsetValue: { flex: 1, textAlign: 'center', color: colors.navy, fontSize: 14, fontWeight: '700' },
  ...
  prayerResultTitle: { color: colors.navy, fontSize: 14, fontWeight: '700' },
  prayerResultTime: { color: colors.tealDark, fontSize: 12, fontWeight: '700', marginTop: spacing.xs },
  duplicateNotice: { gap: 5, padding: spacing.md, borderRadius: radius.md, borderWidth: 1, borderColor: '#f59e0b', backgroundColor: '#fffbeb' },
  duplicateTitle: { color: '#92400e', fontSize: 13, fontWeight: '700' },
  ...
  reciterTitle: { color: colors.navy, fontSize: 13, fontWeight: '700' },
  ...
  sequenceButtonText: { color: colors.tealDark, fontSize: 11, fontWeight: '700' },
  miniLabel: { color: colors.muted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase' },
  ...
  cancelText: { color: colors.tealDark, fontSize: 14, fontWeight: '700' },
  ...
  success: { color: colors.tealDark, fontSize: 14, fontWeight: '600' },
