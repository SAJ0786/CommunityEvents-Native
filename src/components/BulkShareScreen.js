...
const styles = StyleSheet.create({
  ...
  backButtonText: { color: colors.tealDark, fontSize: 13, fontWeight: '700' },
  label: { color: colors.muted, fontSize: 11, fontWeight: '700', textTransform: 'uppercase', marginTop: spacing.lg, marginBottom: 6 },
  ...
  previewTitle: { color: colors.navy, fontSize: 14, fontWeight: '700', marginBottom: spacing.sm },
  ...
  selectedText: { color: colors.tealDark, fontSize: 13, fontWeight: '600', marginLeft: 'auto' },
  ...
  checkboxText: { color: colors.surface, fontSize: 14, fontWeight: '700' },
  ...
  typePillText: { color: colors.tealDark, fontSize: 11, fontWeight: '700' },
  metaPill: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999, backgroundColor: '#fef3c7' },
  metaPillText: { color: '#92400e', fontSize: 11, fontWeight: '600' },
  eventTitle: { color: colors.navy, fontSize: 16, fontWeight: '700' },
