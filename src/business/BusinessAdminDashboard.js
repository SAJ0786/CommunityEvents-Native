...
function PanelHeader({ title, subtitle, onBack }) {
  return <View style={styles.panelHead}><NativeBackButton onPress={onBack} style={styles.backButton} /><Text style={styles.panelTitle}>{title}</Text><Text style={styles.panelSubtitle}>{subtitle}</Text></View>;
}
...
const styles = StyleSheet.create({
  ...
  metrics: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.md }, metric: { width: '31%', minWidth: 96, flexGrow: 1, padding: spacing.md, borderWidth: 1, borderRadius: radius.md, backgroundColor: colors.surface }, metricTone0: { borderColor: '#f0d6e2' }, metricTone1: { borderColor: '#cce2f6' }, metricTone2: { borderColor: '#d7ead8' }, metricTone3: { borderColor: '#eadcc5' }, metricValue: { color: '#a33667', fontSize: 22, fontWeight: '700' }, metricLabel: { marginTop: 3, color: colors.muted, fontSize: 9, lineHeight: 12, fontWeight: '600' },
  sectionTitle: { marginTop: spacing.lg, marginBottom: spacing.sm, color: colors.navy, fontSize: 18, fontWeight: '700' }, areas: { gap: spacing.sm }, area: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: spacing.md, padding: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface }, areaIcon: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#fff0f6' }, areaIconText: { fontSize: 20 }, areaCopy: { flex: 1 }, areaTitle: { color: colors.navy, fontSize: 14, fontWeight: '700' }, areaText: { marginTop: 3, color: colors.muted, fontSize: 11, lineHeight: 15 }, chevron: { color: '#a33667', fontSize: 23, fontWeight: '700' }, pressed: { opacity: 0.75 },
