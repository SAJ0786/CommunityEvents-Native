...
const AREAS = [
  ...
  ['businesses', '\u{1F3EA}', 'Businesses', 'Manage active, pending, rejected, archived and deleted listings.'],
  ['troubleshooting', '\u{1F6E0}', 'Troubleshooting', 'Business diagnostics and support details.'],
...
export default function BusinessAdminDashboard({ user, profile, categories = [] }) {
  ...
  const metrics = useMemo(() => [
    ...
    ['Archived', businesses.filter(item => item.status === 'archived').length, 'businesses'],
    ['Deleted Records', businesses.filter(item => item.status === 'deleted').length, 'businesses'],
...
const styles = StyleSheet.create({
  flex: { flex: 1 }, content: { padding: spacing.lg, paddingBottom: 48 }, keyboardContent: { padding: spacing.lg, paddingBottom: 280 }, identity: { minHeight: 104, flexDirection: 'row', alignItems: 'center', gap: spacing.md, padding: spacing.md, borderRadius: radius.lg, backgroundColor: '#fff0f6', ...shadow }, identityIcon: { width: 52, height: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 17, backgroundColor: '#f7c6dc' }, identityIconText: { fontSize: 26 }, identityCopy: { flex: 1 }, eyebrow: { color: '#a33667', fontSize: 9, fontWeight: '700', letterSpacing: 1 }, title: { marginTop: 3, color: colors.navy, fontSize: 20, fontWeight: '700' }, subtitle: { marginTop: 3, color: colors.muted, fontSize: 11, lineHeight: 16, fontWeight: '700' },
  metrics: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.md }, metric: { width: '31%', minWidth: 96, flexGrow: 1, padding: spacing.md, borderWidth: 1, borderRadius: radius.md, backgroundColor: colors.surface }, metricTone0: { borderColor: '#f0d6e2' }, metricTone1: { borderColor: '#cce2f6' }, metricTone2: { borderColor: '#d7ead8' }, metricTone3: { borderColor: '#eadcc5' }, metricValue: { color: '#a33667', fontSize: 18, fontWeight: '700' }, metricLabel: { marginTop: 3, color: colors.muted, fontSize: 9, lineHeight: 12, fontWeight: '600' },
  sectionTitle: { marginTop: spacing.lg, marginBottom: spacing.sm, color: colors.navy, fontSize: 15, fontWeight: '700' }, areas: { gap: spacing.sm }, area: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: spacing.md, padding: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface }, areaIcon: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#fff0f6' }, areaIconText: { fontSize: 20 }, areaCopy: { flex: 1 }, areaTitle: { color: colors.navy, fontSize: 13, fontWeight: '700' }, areaText: { marginTop: 3, color: colors.muted, fontSize: 11, lineHeight: 15 }, chevron: { color: '#a33667', fontSize: 23, fontWeight: '700' }, pressed: { opacity: 0.75 },
  panelHead: { marginBottom: spacing.md, padding: spacing.md, borderRadius: radius.lg, backgroundColor: '#fff0f6' }, backButton: { alignSelf: 'flex-start', minHeight: 34, justifyContent: 'center' }, backText: { color: '#a33667', fontSize: 12, fontWeight: '700' }, panelTitle: { color: colors.navy, fontSize: 23, fontWeight: '700' }, panelSubtitle: { marginTop: 4, color: colors.muted, fontSize: 12, lineHeight: 18 },
  input: { minHeight: 44, marginTop: spacing.sm, paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface, color: colors.text, fontSize: 13 }, scopeTabs: { flexDirection: 'row', marginTop: spacing.md, padding: 3, borderRadius: radius.md, backgroundColor: '#edf2f1' }, scopeTab: { flex: 1, minHeight: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 10 }, scopeTabActive: { backgroundColor: colors.teal, ...shadow }, scopeText: { color: colors.muted, fontSize: 11, fontWeight: '700' }, scopeTextActive: { color: colors.surface }, resultCount: { marginTop: spacing.md, color: colors.muted, fontSize: 10, fontWeight: '700' }, userCard: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, marginTop: spacing.sm, padding: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface }, userAvatar: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: colors.tealSoft }, userAvatarText: { color: colors.tealDark, fontSize: 17, fontWeight: '700' }, userCopy: { flex: 1 }, userName: { color: colors.navy, fontSize: 13, fontWeight: '700' }, userMeta: { marginTop: 3, color: colors.muted, fontSize: 11 }, userJoined: { marginTop: 5, color: '#a33667', fontSize: 9.5, fontWeight: '700' },
  infoCard: { marginBottom: spacing.md, padding: spacing.md, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, backgroundColor: colors.surface, ...shadow }, infoLabel: { color: '#a33667', fontSize: 10, fontWeight: '700', letterSpacing: 0.6 }, infoValue: { marginTop: 7, color: colors.navy, fontSize: 15, fontWeight: '700' }, infoText: { marginTop: spacing.sm, color: colors.muted, fontSize: 11, lineHeight: 17 }, validation: { marginTop: spacing.sm, fontSize: 11, fontWeight: '700' }, valid: { color: '#27753a' }, invalid: { color: colors.danger }, primaryButton: { minHeight: 44, alignItems: 'center', justifyContent: 'center', marginTop: spacing.md, borderRadius: radius.md, backgroundColor: '#a33667' }, primaryButtonText: { color: colors.surface, fontSize: 12, fontWeight: '700' }, disabled: { opacity: 0.4 },
  formRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, flexInput: { flex: 1 }, iconChooser: { width: 88, minHeight: 66, alignItems: 'center', justifyContent: 'center', marginTop: spacing.sm, borderWidth: 1, borderColor: colors.teal, borderRadius: radius.md, backgroundColor: colors.tealSoft }, iconChooserValue: { fontSize: 25 }, iconChooserLabel: { marginTop: 2, color: colors.tealDark, fontSize: 8.5, fontWeight: '700' }, divider: { height: 1, marginVertical: spacing.lg, backgroundColor: colors.border }, selectWrap: { marginTop: spacing.sm }, categoryStatus: { marginTop: spacing.md, color: colors.tealDark, fontSize: 11, lineHeight: 17, fontWeight: '600' }, categorySummary: { marginTop: spacing.lg, borderTopWidth: 1, borderTopColor: colors.border }, categorySummaryRow: { minHeight: 46, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm, borderBottomWidth: 1, borderBottomColor: colors.border }, categorySummaryName: { flex: 1, color: colors.navy, fontSize: 11, fontWeight: '700' }, categorySummaryCount: { color: colors.muted, fontSize: 9, fontWeight: '600' }, modalBackdrop: { flex: 1, justifyContent: 'center', padding: spacing.lg, backgroundColor: 'rgba(7,18,35,0.58)' }, iconModal: { maxHeight: '76%', padding: spacing.lg, borderRadius: radius.lg, backgroundColor: colors.surface, ...shadow }, iconModalHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm }, iconModalTitle: { color: colors.navy, fontSize: 19, fontWeight: '700' }, modalClose: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 19, backgroundColor: colors.tealSoft }, modalCloseText: { color: colors.tealDark, fontSize: 16, fontWeight: '700' }, iconGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.md, paddingBottom: spacing.sm }, iconOption: { width: 50, height: 50, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.border, borderRadius: 14, backgroundColor: '#f8faf9' }, iconOptionActive: { borderColor: colors.teal, borderWidth: 2, backgroundColor: colors.tealSoft }, iconOptionText: { fontSize: 25 },
});
