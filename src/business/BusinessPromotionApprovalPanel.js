...
const styles = StyleSheet.create({
  ...
  title: { color: colors.navy, fontSize: 15, lineHeight: 19, fontWeight: '700' },
  business: { marginTop: 3, color: colors.muted, fontSize: 10, fontWeight: '600' },
  status: { alignSelf: 'flex-start', marginTop: 6, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 99, overflow: 'hidden', backgroundColor: '#fff2d8', color: '#8b5c08', fontSize: 8, fontWeight: '700' },
  ...
  offer: { marginTop: spacing.md, color: '#aa6507', fontSize: 14, fontWeight: '700' },
  ...
  metaLabel: { color: colors.muted, fontSize: 8, fontWeight: '700' },
  metaValue: { marginTop: 3, color: colors.navy, fontSize: 10, fontWeight: '600' },
  ...
  boostCopy: { flex: 1 },
  boostTitle: { color: colors.navy, fontSize: 12, fontWeight: '700' },
  ...
  approveText: { color: colors.surface, fontSize: 10.5, fontWeight: '700' },
  ...
  rejectText: { color: colors.danger, fontSize: 10, fontWeight: '700' },
