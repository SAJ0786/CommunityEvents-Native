...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, minWidth: 0, color: colors.text, fontSize: 14, fontWeight: '500', letterSpacing: 0 },
  ...
  sectionSubtitle: { marginTop: 2, color: colors.muted, fontSize: 11, fontWeight: '500', letterSpacing: 0 },
