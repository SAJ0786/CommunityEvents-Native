...
import { LEGAL_DOCUMENT_VERSION, LEGAL_URLS } from '../config/legal';
...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 5, color: colors.navy, fontSize: 27, lineHeight: 32, fontWeight: '700' },
  ...
  closeText: { color: colors.tealDark, fontSize: 17, fontWeight: '700' },
  signInCard: { marginBottom: spacing.lg, padding: spacing.lg, borderRadius: radius.lg, backgroundColor: colors.tealSoft },
  signInTitle: { color: colors.navy, fontSize: 17, fontWeight: '700' },
  ...
  sectionTitle: { marginTop: 6, color: colors.navy, fontSize: 19, fontWeight: '700' },
  ...
  label: { color: colors.navy, fontSize: 12, fontWeight: '700', textTransform: 'uppercase' },
  optional: { color: colors.muted, fontSize: 9, fontWeight: '700' },
  ...
  errorText: { color: colors.danger, fontSize: 11, lineHeight: 16, fontWeight: '600' },
  validText: { color: '#2d7d43', fontSize: 11, fontWeight: '700' },
  ...
  abrResultTitle: { color: '#2d7d43', fontSize: 11, fontWeight: '700' },
  abrResultText: { marginTop: 3, color: colors.navy, fontSize: 11, lineHeight: 16, fontWeight: '600' },
  ...
  abrRetryText: { color: colors.tealDark, fontSize: 10.5, fontWeight: '700' },
  ...
  subcategoryText: { color: colors.muted, fontSize: 10, fontWeight: '600' },
  subcategoryTextActive: { color: colors.tealDark, fontWeight: '700' },
  ...
  categoryTileText: { color: colors.text, fontSize: 9.5, lineHeight: 12, fontWeight: '600', textAlign: 'center' },
  ...
  activeCategorySummary: { color: colors.tealDark, fontSize: 10, fontWeight: '700' },
  ...
  removeCategoryText: { color: colors.danger, fontSize: 9, fontWeight: '700' },
  ...
  serviceTileText: { color: colors.muted, fontSize: 10, lineHeight: 14, fontWeight: '600', textAlign: 'center' },
  serviceTileTextActive: { color: colors.tealDark, fontWeight: '700' },
  ...
  imagePlaceholderText: { color: colors.muted, fontSize: 10, fontWeight: '600' },
  ...
  messageSuccessText: { color: '#2d7d43', fontSize: 12, lineHeight: 18, fontWeight: '600' },
  ...
  declarationTitle: { color: colors.navy, fontSize: 13, fontWeight: '700' },
  declarationText: { marginTop: 5, color: colors.text, fontSize: 11, lineHeight: 17, fontWeight: '600' },
  legalLinks: { marginTop: spacing.sm, flexDirection: 'row', flexWrap: 'wrap', gap: spacing.md },
  legalLink: { color: colors.blue, fontSize: 12, lineHeight: 18, fontWeight: '700', textDecorationLine: 'underline' },
  ...
  primaryButtonText: { color: colors.surface, fontSize: 13, fontWeight: '700', textAlign: 'center' },
  ...
  submitText: { color: colors.surface, fontSize: 15, fontWeight: '700', textAlign: 'center' },
