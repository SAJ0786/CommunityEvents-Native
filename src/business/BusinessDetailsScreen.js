...
export default function BusinessDetailsScreen({ business, promotions = [], saved = false, onBack, onToggleSaved, isGuest = true, user, profile, onRequireSignIn, onTrackAction }) {
  ...
  const contactBusiness = async () => {
    ...
    try {
      ...
      setContactText('');
      setContactStatus('Message sent. Follow the conversation in Business Inbox.');
    } catch (error) {
...
const styles = StyleSheet.create({
  ...
  backText: { color: colors.tealDark, fontSize: 15, fontWeight: '700' },
  ...
  saveIcon: { color: colors.muted, fontSize: 27, fontWeight: '700' },
  ...
  coverInitials: { color: '#ffffff', fontSize: 58, fontWeight: '700', letterSpacing: 2 },
  ...
  logoText: { fontSize: 23, fontWeight: '700' },
  ...
  title: { flex: 1, minWidth: 0, color: colors.navy, fontSize: 27, lineHeight: 32, fontWeight: '700' },
  ...
  promotionPulseText: { color: '#9a5c05', fontSize: 8, fontWeight: '700' },
  ...
  verifiedText: { color: '#337641', fontSize: 11, fontWeight: '700' },
  ...
  disclaimerTitle: { color: colors.tealDark, fontSize: 12, fontWeight: '700' },
  ...
  actionIcon: { color: colors.tealDark, fontSize: 20, fontWeight: '700' },
  actionLabel: { marginTop: 4, color: colors.tealDark, fontSize: 10, fontWeight: '700' },
  ...
  activeTabText: { color: colors.tealDark, fontWeight: '700' },
  ...
  servicesActionTitle: { color: colors.tealDark, fontSize: 13, fontWeight: '700' },
  servicesActionText: { marginTop: 2, color: colors.muted, fontSize: 10.5, fontWeight: '700' },
  servicesActionChevron: { color: colors.tealDark, fontSize: 20, fontWeight: '700' },
  ...
  serviceChipText: { color: colors.text, fontSize: 10.5, fontWeight: '600' },
  ...
  infoIcon: { color: colors.tealDark, fontSize: 17, fontWeight: '700' },
  infoCopy: { flex: 1, minWidth: 0 },
  infoTitle: { color: colors.navy, fontSize: 14, fontWeight: '700' },
  infoText: { marginTop: 3, color: colors.muted, fontSize: 12, lineHeight: 18, fontWeight: '600' },
  infoChevron: { alignSelf: 'center', color: colors.tealDark, fontSize: 22, fontWeight: '700' },
  ...
  hoursDay: { color: colors.navy, fontSize: 13, fontWeight: '600' },
  ...
  promotionEyebrow: { color: '#9a5c05', fontSize: 10, fontWeight: '700' },
  promotionTitle: { marginTop: 5, color: colors.navy, fontSize: 17, fontWeight: '700' },
  ...
  contactCancel: { minHeight: 44, alignItems: 'center', justifyContent: 'center' }, contactCancelText: { color: colors.tealDark, fontWeight: '700' }, disabled: { opacity: 0.45 },
