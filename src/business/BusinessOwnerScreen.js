...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 5, color: colors.navy, fontSize: 25, fontWeight: '700' },
  ...
  summaryValue: { color: colors.navy, fontSize: 22, fontWeight: '700' },
  summaryLabel: { marginTop: 3, color: colors.muted, fontSize: 8.5, fontWeight: '700' },
  ...
  addTitle: { color: colors.surface, fontSize: 14, fontWeight: '700' },
  addText: { marginTop: 2, color: '#d8f3ef', fontSize: 10.5, fontWeight: '700' },
  chevron: { color: colors.surface, fontSize: 28, fontWeight: '700' },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginTop: spacing.lg, marginBottom: spacing.sm },
  sectionTitle: { color: colors.navy, fontSize: 19, fontWeight: '700' },
  sectionCount: { minWidth: 24, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 99, backgroundColor: colors.tealSoft, color: colors.tealDark, fontSize: 10, fontWeight: '700', textAlign: 'center' },
  list: { gap: spacing.md },
  ...
  businessLogoText: { color: colors.surface, fontSize: 17, fontWeight: '700' },
  ...
  infoLabel: { color: colors.muted, fontSize: 7.5, fontWeight: '700' },
  infoValue: { marginTop: 3, color: colors.text, fontSize: 9.5, fontWeight: '700' },
  ...
  rejectionTitle: { color: colors.danger, fontSize: 11, fontWeight: '700' },
  ...
  editIcon: { color: colors.tealDark, fontSize: 14, fontWeight: '700' },
  editText: { color: colors.tealDark, fontSize: 11, fontWeight: '700' },
  ...
  promotionButtonText: { color: '#92590a', fontSize: 10, fontWeight: '700' },
  publicState: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  publicStateIcon: { fontSize: 13 },
  publicStateText: { color: colors.muted, fontSize: 10, fontWeight: '600' },
  ...
  promotionTitle: { color: colors.navy, fontSize: 14, lineHeight: 18, fontWeight: '700' },
  promotionBusiness: { marginTop: 3, color: colors.muted, fontSize: 10, fontWeight: '600' },
  ...
  promotionStatusText: { color: '#8b5c08', fontSize: 8, fontWeight: '700' },
  promotionStatusTextActive: { color: '#2f7740' },
  promotionStatusTextRejected: { color: colors.danger },
  promotionSummary: { marginTop: spacing.sm, color: colors.text, fontSize: 11, lineHeight: 16, fontWeight: '600' },
  promotionDates: { marginTop: 4, color: colors.muted, fontSize: 9.5, fontWeight: '700' },
  promotionReason: { marginTop: spacing.sm, padding: spacing.sm, borderRadius: 9, backgroundColor: '#ffeded', color: colors.danger, fontSize: 10, lineHeight: 15, fontWeight: '600' },
  ...
  promotionEditText: { color: colors.tealDark, fontSize: 10.5, fontWeight: '700' },
  promotionDelete: { minHeight: 38, justifyContent: 'center', paddingHorizontal: spacing.md },
  promotionDeleteText: { color: colors.danger, fontSize: 10.5, fontWeight: '700' },
  ...
  emptyTitle: { marginTop: spacing.sm, color: colors.navy, fontSize: 18, fontWeight: '700', textAlign: 'center' },
  ...
  primaryButtonText: { color: colors.surface, fontSize: 12, fontWeight: '700' },
  ...
  processTitle: { paddingTop: spacing.lg, color: colors.navy, fontSize: 15, fontWeight: '700' },
  ...
  processNumberText: { color: colors.tealDark, fontSize: 12, fontWeight: '700' },
  processCopy: { flex: 1, minWidth: 0 },
  processRowTitle: { color: colors.navy, fontSize: 12, fontWeight: '700' },
